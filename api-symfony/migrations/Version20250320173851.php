 ...
 */
final class Version20250320173851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, id_univ INT NOT NULL, id_user INT NOT NULL, nom VARCHAR(255) NOT NULL, img VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_3BAE0AA76C6E55B5 (nom), INDEX IDX_3BAE0AA7B995717D (id_univ), INDEX IDX_3BAE0AA76B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
